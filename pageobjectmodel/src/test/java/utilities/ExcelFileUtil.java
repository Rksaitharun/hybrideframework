...
public static void main(String[] args) throws Throwable {
	...
	ExcelFileUtil xl = new ExcelFileUtil("./FileInput/customer_data.xlsx");
	//count no of rows in sheet
	int rc =xl.rowCount("customer");
	System.out.println(rc);
	for(int i=1;i<=rc;i++)
	{
		String fname = xl.getCellData("customer", i, 0);
		String lname = xl.getCellData("customer", i, 1);
		String eid = xl.getCellData("customer", i, 2);
		System.out.println(fname+"   "+lname+"  "+eid);
		//xl.setCellData("Emp", i, 4, "Pass", "D:/Results.xlsx");
		//xl.setCellData("Emp", i, 4, "Fail", "D:/Results.xlsx");
		xl.setCellData("customer", i, 3, "Blocked", "./Results.xlsx");
	}
